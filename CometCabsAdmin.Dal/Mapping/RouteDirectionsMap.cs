...
{
    public class RouteDirectionsMap : EntityTypeConfiguration<RouteDirections>
    {
        public RouteDirectionsMap()
        {
            HasKey(t => t.Id);
            ...
            Property(t => t.TagName).IsRequired().HasColumnType("nvarchar").HasMaxLength(20);
            ...
            HasRequired<Route>(t => t.Route)
                .WithMany(t => t.RouteDirections);

            ToTable("RouteDirections");
        }
    }
}
